...
const allAnimUnlock = {
  ...
  anim3: {
    box1: "translateX(40px) translateY(-60px) scale(0.2)",
    box2: "translateX(13px) translateY(-60px) scale(0.2)",
    box3: "translateX(-13px) translateY(-60px) scale(0.2)",
    box4: "translateX(-40px) translateY(-60px) scale(0.2)",
    box5: "translateX(-40px) translateY(-80px) scale(0.2)",
    box6: "translateX(-13px) translateY(-80px) scale(0.2)",
    box7: "translateX(13px) translateY(-80px) scale(0.2)",
    box8: "translateX(40px) translateY(-80px) scale(0.2)",
    box9: "translateX(25px) translateY(-60px) scale(0.2)",
    box10: "translateX(25px) translateY(-30px) scale(0.2)",
    box12: "translateX(-25px) translateY(-45px) scale(0.2)",
    box11: "translateX(0px) translateY(80px) scale(0.2)",
  },
  anim4: {
    box1: "scale(1)",
